//Prebuilding the pages that exist...gives fast rendering
...
function Post({ post }: Props) {
  ...
  // making a post request of all the form data into the backend
    ...
    <main>
        ...
        <article className="max-w-3xl mx-auto p-5">
            ...
            <div className="mt-3">
                <PortableText 
                    ...
                    content={post.body}
                    serializers={{
                        h1: (props: any) => <h1 className="txt-2xl font-bold my-5" {...props} />,
                        h2: (props: any) => <h2 className="txt-2xl font-bold my-5" {...props} />,
        ...
        {submitted ? (
            <div className="flex flex-col p-10 my-10 bg-yellow-500
                ...
                <p>Once it has been approved, it will appear down below!</p>
            </div>
        ) : (
            ...
            <form  onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-10 max-w-2xl mx-auto mb-10">
                ...
                <label className="block mb-5">
                    ...
                    <textarea 
                        ...
                        placeholder="Write down your views!" 
                        rows={8} 
                    />
                </label>
                ...
                <div className="flex flex-col p-5">
                    ...
                    {errors.name && (
                        <span className="text-red-500">The Email Field field is required</span>
                    )}
                </div>
...
// the code below gives an array of paths which gives all the respective slugs
...
//This code below uses the slugs generated above to fetch the inforation for each page
